...
export default function BottomNav({ activePage, setPageType }) {
  ...
  return (
    ...
    <div className="fixed bottom-4 left-0 right-0 flex justify-center px-4">
      <div className="bg-gray-900 shadow-lg rounded-full p-2 flex space-x-4 backdrop-blur-md border border-gray-700 font-mono">
        {/* Home Button */}
        <Button
          variant="ghost"
          size="icon"
        ...
        >
          ...
          <Home
            className={`w-6 h-6 relative ${
              activePage === "home" ? "text-gray-900" : "text-gray-300"
            }`}
          />
        </Button>
        ...
        >
          ...
          <MessageSquare
            className={`w-6 h-6 relative ${
              activePage === "chat" ? "text-gray-900" : "text-gray-300"
            }`}
          />
        </Button>
      </div>
